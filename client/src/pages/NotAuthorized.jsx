...
function NotAuthorized() {
  ...
  return (
    <div className="page-shell min-h-screen flex flex-col">
      <header className="relative z-[1] w-[min(1200px,calc(100%-48px))] mx-auto pt-[22px] pb-2.5 flex items-center border-b border-[rgba(148,175,211,0.15)]">
      ...
      <main className="relative z-[1] flex-1 flex items-center justify-center p-6">
        ...
        <div className="w-full max-w-lg panel-strong p-8 md:p-12 text-center flex flex-col items-center gap-6 animate-fade-up shadow-[0_20px_60px_rgba(2,11,23,0.6)]">
          {/* 403 badge */}
